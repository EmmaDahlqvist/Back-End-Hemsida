    ...
    if(req.body.new_password == req.body.confirm_password){
      if(!takenUsernames.includes(req.body.new_username)){
        if(!takenMailAdress.includes(req.body.new_mail)){
          ...
          res.render('profile', Object.assign(theUser, {errorMsg: "Denna mailadress tillhör någon annan!"}))
        }
      } else {
        res.render('profile', Object.assign(theUser, {errorMsg: "Detta användarnamn tillhör någon annan!"}))
      }
    } else {
      res.render('profile', Object.assign(theUser, {errorMsg: "Lösenorden stämmer inte överens!"}))
    }
  } else {
    res.render('profile', Object.assign(theUser, {errorMsg: "Det gamla lösenordet var fel!"}))
  }
})
